            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <input type="file" name="image" accept="image/jpeg, image/jpg, image/png" class="col-8 col-form-label text-md-end mx-auto  @error('image') is-invalid @enderror" required style="font-size: 8px;">
                            @error('image')
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="row mb-3">
                                <label for="age" class="col-6 col-form-label fs-6">{{ __('Age') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="height" class="col-6 col-form-label fs-6">{{ __('height') }}</label>
